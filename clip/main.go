...
func Handler(details *hue.AdvertiseDetails) func (w http.ResponseWriter, r *http.Request) {
	return func (w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/api/nouser/config" {
			NoUserConfig(details)(w, r)
		} else if r.URL.Path == "/api/" && r.Method == "POST" {
